...
开发计划、配置模板和AI代理执行合同已放入仓库根目录的Unity `6000.5.1f1` 2D工程。当前仅完成T000合同统一，尚未通过T010 Editor冒烟，也未实现玩法或通过微信真机审核。平台状态仍为pending，必须按T100–T120保存标准Web、微信转换、开发者工具和真机四级证据。
