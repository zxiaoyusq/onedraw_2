...
| T410 | P4 玩家敌人技能 | READY | T400, T230 | 3.0 | 实现数据驱动Skill到EffectGroup到有序Effect执行链。 |
...
- **验证：** AssetImportValidationTests；真机视觉冒烟。
