...
namespace OneStrokeDemon.Tests.EditMode.T230
{
    ...
    public sealed class RuntimeConfigLoadTests
    {
        ...
        public void GeneratedSnapshotLoadsOnceAndBuildsReadOnlyIndexes()
        {
            ...
            Assert.That(summary.ContentVersion, Is.EqualTo("0.6.4-sample"));
            Assert.That(summary.ContentHash, Is.EqualTo("e348bab0eaf2bce5fa21c0588eb53c3b755791d8a537c4d7f29c93110ee6522c"));
            ...
            Assert.That(summary.ToLogMessage(), Does.Contain("records=745"));
